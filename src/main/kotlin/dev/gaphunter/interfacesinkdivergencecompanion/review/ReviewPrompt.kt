package dev.gaphunter.interfacesinkdivergencecompanion.review
...
object ReviewPrompt {
    ...
    private const val KEY_SEEN_FINDINGS = "dev.gaphunter.interfacesinkdivergencecompanion.review.seenFindings"
    private const val KEY_ANSWERED = "dev.gaphunter.interfacesinkdivergencecompanion.review.answered"

    private const val NOTIFICATION_GROUP_ID = "Interface Sink Divergence Companion"

    // Marketplace listing (real ID resolved after first publish).
    private const val MARKETPLACE_URL = "https://plugins.jetbrains.com/plugin/34077-interface-sink-divergence-companion/reviews"
